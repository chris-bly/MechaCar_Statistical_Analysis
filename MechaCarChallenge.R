...
# t.test(sample_table$PSI,mu=mean(coil_table$PSI)) #compare sample versus population means, but realized I need to test against 1500 PSI and not the mean of all lots to remove bias
